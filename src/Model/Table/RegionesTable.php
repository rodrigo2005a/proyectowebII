 ...
 * @method iterable<\App\Model\Entity\Region>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\Region> saveManyOrFail(iterable $entities, $options = [])
 * @method \Cake\ORM\Query\SelectQuery findAll()
 */
class RegionesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('paises')
            ->maxLength('paises', 255)
            ->requirePresence('paises', 'create')
            ->notEmptyString('paises');

        $validator
            ->decimal('superficie_km2')
            ->allowEmptyString('superficie_km2');
